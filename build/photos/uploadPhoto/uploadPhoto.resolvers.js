    ...
    Mutation: {
        uploadPhoto: users_utils_1.protectedResolver(function (_, _a, _b) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                var hashtagObj, fileUrl, photo;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            hashtagObj = [];
                            if (caption) {
                                hashtagObj = photos_utils_1.getHashtags(caption);
                            }
                            return [4 /*yield*/, shared_utils_1.uploadToS3(file, loggedInUser.id, "photos")];
                        case 1:
                            fileUrl = _c.sent();
                            ...
                            return [2 /*return*/, { ok: true, photo: photo }];
                    }
                });
            });
        }),
