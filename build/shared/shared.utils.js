...
var uploadToS3 = function (file, userId, folderName) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, filename, createReadStream, readStream, name, Location;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                name = folderName + "/" + userId + "_" + Date.now() + "_" + filename;
...
var deleteFromS3 = function (fileUrl, folderName) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, ok;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                filename = fileUrl.split("/" + folderName + "/")[1];
                return [4 /*yield*/, new AWS.S3()
                        .deleteObject({
